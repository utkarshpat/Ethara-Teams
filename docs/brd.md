...
## Product Vision
Ethara Teams is a unified work environment for small teams that need project planning, task execution, and task-level collaboration in one fast web app.
...
- Admins can see task status, priority mix, and overdue work from the dashboard.
...
- Task creation, assignment, Kanban movement, soft deletion, and overdue tracking.
- Task-level chat comments with mention-triggered notifications.
- PWA installability with app manifest and service worker.
- Dashboard analytics for status, priority, and overdue workload.

## Out Of Scope For Foundation
- Billing and subscriptions.
- File attachments.
- Advanced workflow automation.
- Multi-organization billing tenants.
- Mobile native apps.
